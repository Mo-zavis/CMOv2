...
export function registerContactLabelTools({ server, client }) {
    server.tool('chatwoot_get_contact_labels', 'Get all labels assigned to a contact.', {
    ...
    server.tool('chatwoot_set_contact_labels', 'Set labels on a contact (replaces all existing labels).', {
        contact_id: z.number().describe('ID of the contact'),
...
//# sourceMappingURL=contact-labels.js.map