...
export function registerCannedResponseTools({ server, client }) {
    server.tool('chatwoot_list_canned_responses', 'List canned responses, optionally filtered by a search term.', {
    ...
    server.tool('chatwoot_create_canned_response', 'Create a new canned response.', {
    ...
    server.tool('chatwoot_update_canned_response', 'Update an existing canned response.', {
        ...
        try {
            const body = {};
            if (args.short_code !== undefined)
                body.short_code = args.short_code;
    ...
    server.tool('chatwoot_delete_canned_response', 'Delete a canned response.', {
...
//# sourceMappingURL=canned-responses.js.map