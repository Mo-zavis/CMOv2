...
export function registerPublicContactTools({ server, client }) {
    server.tool('chatwoot_public_create_contact', 'Create a new contact via the public API for a specific inbox.', {
    ...
    server.tool('chatwoot_public_get_contact', 'Get a public contact by inbox and contact identifier.', {
        inbox_identifier: z.string().describe('Identifier of the inbox'),
    ...
    server.tool('chatwoot_public_update_contact', 'Update a public contact by inbox and contact identifier.', {
        inbox_identifier: z.string().describe('Identifier of the inbox'),
        contact_identifier: z.string().describe('Identifier of the contact'),
