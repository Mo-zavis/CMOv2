...
export function registerCustomAttributeTools({ server, client }) {
    server.tool('chatwoot_list_custom_attributes', 'List custom attribute definitions, optionally filtered by model type.', {
        ...
        try {
            ...
            if (args.attribute_model)
                params.attribute_model = args.attribute_model;
    ...
    server.tool('chatwoot_create_custom_attribute', 'Create a new custom attribute definition.', {
        ...
        try {
            ...
            if (args.attribute_description !== undefined)
                body.attribute_description = args.attribute_description;
            if (args.attribute_values !== undefined)
                body.attribute_values = args.attribute_values;
    ...
    server.tool('chatwoot_get_custom_attribute', 'Get a custom attribute definition by ID.', {
    ...
    server.tool('chatwoot_update_custom_attribute', 'Update a custom attribute definition.', {
    ...
    server.tool('chatwoot_delete_custom_attribute', 'Delete a custom attribute definition.', {
