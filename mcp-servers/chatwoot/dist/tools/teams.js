...
export function registerTeamTools({ server, client }) {
    server.tool('chatwoot_list_teams', 'List all teams in the Chatwoot account.', {}, async () => {
        try {
    ...
    server.tool('chatwoot_create_team', 'Create a new team in the Chatwoot account.', {
        ...
        try {
            ...
            if (args.allow_auto_assign !== undefined)
                body.allow_auto_assign = args.allow_auto_assign;
    ...
    server.tool('chatwoot_get_team', 'Get details of a specific team.', {
    ...
    server.tool('chatwoot_update_team', 'Update an existing team in the Chatwoot account.', {
    ...
    server.tool('chatwoot_delete_team', 'Delete a team from the Chatwoot account.', {
