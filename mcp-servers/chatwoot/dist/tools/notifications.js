...
export function registerNotificationTools({ server, client }) {
    server.tool('chatwoot_list_notifications', 'List notifications with optional pagination.', {
        ...
        try {
            ...
            if (args.includes_count !== undefined)
                params.includes_count = String(args.includes_count);
    ...
    server.tool('chatwoot_update_notification', 'Mark a notification as read or unread.', {
        ...
        try {
            const body = {};
            if (args.read_at !== undefined)
                body.read_at = args.read_at;
    ...
    server.tool('chatwoot_delete_notification', 'Delete a notification.', {
    ...
    server.tool('chatwoot_read_all_notifications', 'Mark all notifications as read.', {}, async () => {
        try {
    ...
    server.tool('chatwoot_unread_notification_count', 'Get the count of unread notifications.', {}, async () => {
        try {
    ...
    server.tool('chatwoot_delete_all_notifications', 'Delete all notifications.', {}, async () => {
        try {
