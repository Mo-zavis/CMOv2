...
export function registerPlatformAccountUserTools({ server, client }) {
    server.tool('chatwoot_platform_list_account_users', 'List all users in a specific Chatwoot account.', {
    ...
    server.tool('chatwoot_platform_create_account_user', 'Add a user to a Chatwoot account.', {
        account_id: z.number().describe('ID of the account'),
        ...
        try {
            const body = { user_id: args.user_id };
    ...
    server.tool('chatwoot_platform_delete_account_user', 'Remove a user from a Chatwoot account.', {
        account_id: z.number().describe('ID of the account'),
...
//# sourceMappingURL=account-users.js.map