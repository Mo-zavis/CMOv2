...
export function registerPlatformUserTools({ server, client }) {
    server.tool('chatwoot_platform_list_users', 'List all users on the Chatwoot platform.', {
    ...
    server.tool('chatwoot_platform_create_user', 'Create a new user on the Chatwoot platform.', {
    ...
    server.tool('chatwoot_platform_get_user', 'Get details of a specific user by ID.', {
    ...
    server.tool('chatwoot_platform_update_user', 'Update an existing user on the Chatwoot platform.', {
    ...
    server.tool('chatwoot_platform_get_user_sso_link', 'Get the SSO login URL for a specific user.', {
        id: z.number().describe('ID of the user'),
    }, async (args) => {
        try {
