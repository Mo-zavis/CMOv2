...
export function registerProfileTools({ server, client }) {
    server.tool('chatwoot_get_profile', 'Get the current authenticated user profile.', {}, async () => {
        try {
    ...
    server.tool('chatwoot_update_profile', 'Update the current authenticated user profile.', {
