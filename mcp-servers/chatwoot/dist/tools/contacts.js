...
export function registerContactTools({ server, client }) {
    server.tool('chatwoot_list_contacts', 'List contacts with pagination and sorting options.', {
        ...
        try {
            ...
            if (args.include_count !== undefined)
                params.include_count = String(args.include_count);
    ...
    server.tool('chatwoot_create_contact', 'Create a new contact.', {
        ...
        try {
            ...
            if (args.phone_number !== undefined)
                body.phone_number = args.phone_number;
    ...
    server.tool('chatwoot_get_contact', 'Get a single contact by ID.', {
    ...
    server.tool('chatwoot_update_contact', 'Update a contact by ID.', {
    ...
    server.tool('chatwoot_delete_contact', 'Delete a contact by ID.', {
    ...
    server.tool('chatwoot_search_contacts', 'Search contacts by name, email, phone number, or identifier.', {
    ...
    server.tool('chatwoot_filter_contacts', 'Filter contacts using advanced query filters.', {
    ...
    server.tool('chatwoot_import_contacts', 'Import contacts from a JSON array.', {
    ...
    server.tool('chatwoot_merge_contacts', 'Merge a contact into another (base) contact.', {
    ...
    server.tool('chatwoot_list_contact_conversations', 'List all conversations for a specific contact.', {
    ...
    server.tool('chatwoot_list_contactable_inboxes', 'List inboxes that are available for a specific contact.', {
        id: z.number().describe('ID of the contact'),
    }, async (args) => {
        try {
    ...
    server.tool('chatwoot_get_contact_activities', 'Get the activity log for a specific contact.', {
        id: z.number().describe('ID of the contact'),
        page: z.number().optional().describe('Page number for pagination'),
    }, async (args) => {
        try {
