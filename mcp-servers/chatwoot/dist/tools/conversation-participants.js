...
export function registerConversationParticipantTools({ server, client }) {
    server.tool('chatwoot_list_conversation_participants', 'List all participants in a conversation.', {
    ...
    server.tool('chatwoot_add_conversation_participants', 'Add participants to a conversation.', {
        conversation_id: z.number().describe('ID of the conversation'),
    ...
    server.tool('chatwoot_update_conversation_participants', 'Update (replace) participants in a conversation.', {
        conversation_id: z.number().describe('ID of the conversation'),
    ...
    server.tool('chatwoot_delete_conversation_participants', 'Remove participants from a conversation.', {
        conversation_id: z.number().describe('ID of the conversation'),
...
//# sourceMappingURL=conversation-participants.js.map