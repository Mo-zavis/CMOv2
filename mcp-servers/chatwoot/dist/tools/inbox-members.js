...
export function registerInboxMemberTools({ server, client }) {
    server.tool('chatwoot_list_inbox_members', 'List all members (agents) assigned to an inbox.', {
    ...
    server.tool('chatwoot_add_inbox_members', 'Add agents as members to an inbox.', {
        inbox_id: z.number().describe('ID of the inbox'),
    ...
    server.tool('chatwoot_update_inbox_members', 'Update (replace) the members of an inbox.', {
        inbox_id: z.number().describe('ID of the inbox'),
    ...
    server.tool('chatwoot_delete_inbox_members', 'Remove agents from an inbox.', {
        inbox_id: z.number().describe('ID of the inbox'),
...
//# sourceMappingURL=inbox-members.js.map