...
export function registerAgentTools({ server, client }) {
    server.tool('chatwoot_list_agents', 'List all agents in the Chatwoot account.', {}, async () => {
        try {
    ...
    server.tool('chatwoot_create_agent', 'Create a new agent in the Chatwoot account.', {
        ...
        try {
            ...
            if (args.auto_offline !== undefined)
                body.auto_offline = args.auto_offline;
    ...
    server.tool('chatwoot_update_agent', 'Update an existing agent in the Chatwoot account.', {
    ...
    server.tool('chatwoot_delete_agent', 'Delete an agent from the Chatwoot account.', {
