...
export function registerAutomationRuleTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_list_automation_rules',
    'List all automation rules with optional pagination.',
    {
  ...
  server.tool(
    'chatwoot_create_automation_rule',
  ...
  server.tool(
    'chatwoot_update_automation_rule',
  ...
  server.tool(
    'chatwoot_delete_automation_rule',
