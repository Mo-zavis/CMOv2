...
export function registerReportTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_get_account_summary',
    'Get account-level summary report for a given time range.',
    {
  ...
  server.tool(
    'chatwoot_get_agent_summary',
    'Get agent-level summary report for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_agent_conversations',
    'Get agent conversation metrics for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
      type: z.enum(['account']).optional().describe('Report type'),
  ...
  server.tool(
    'chatwoot_get_inbox_summary',
    'Get inbox-level summary report for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_inbox_conversations',
    'Get inbox conversation metrics for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_team_summary',
    'Get team-level summary report for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_team_conversations',
    'Get team conversation metrics for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_label_summary',
    'Get label-level summary report for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_label_conversations',
    'Get label conversation metrics for a given time range.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
    },
  ...
  server.tool(
    'chatwoot_get_conversation_metrics',
    'Get overall conversation metrics for a given time range.',
    {
  ...
  server.tool(
    'chatwoot_get_csat_reports',
    'Get CSAT (customer satisfaction) reports for agents.',
    {
      since: z.string().describe('Start time as Unix timestamp'),
      until: z.string().describe('End time as Unix timestamp'),
  ...
  server.tool(
    'chatwoot_get_overview_reports',
    'Get live overview/metrics for the account.',
    {},
    async () => {
      try {
