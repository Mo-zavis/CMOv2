...
export function registerCustomFilterTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_list_custom_filters',
    'List custom filters, optionally filtered by type.',
    {
