...
export function registerInboxTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_list_inboxes',
    'List all inboxes in the Chatwoot account.',
    {},
    async () => {
      try {
  ...
  server.tool(
    'chatwoot_create_inbox',
    'Create a new inbox in the Chatwoot account.',
    {
  ...
  server.tool(
    'chatwoot_delete_inbox',
    'Delete an inbox from the Chatwoot account.',
    {
  ...
  server.tool(
    'chatwoot_get_inbox_agent_bot',
    'Get the agent bot configuration for an inbox.',
    {
      id: z.number().describe('ID of the inbox'),
    },
    async (args) => {
  ...
  server.tool(
    'chatwoot_set_inbox_agent_bot',
    'Set or remove the agent bot for an inbox.',
    {
      id: z.number().describe('ID of the inbox'),
  ...
  server.tool(
    'chatwoot_list_inbox_assignable_agents',
    'List agents that can be assigned to conversations in an inbox.',
    {
      id: z.number().describe('ID of the inbox'),
    },
    async (args) => {
  ...
  server.tool(
    'chatwoot_get_inbox_csat',
    'Get CSAT survey settings for an inbox.',
    {
      id: z.number().describe('ID of the inbox'),
    },
    async (args) => {
