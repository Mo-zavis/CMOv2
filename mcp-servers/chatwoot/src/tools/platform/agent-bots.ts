...
export function registerPlatformAgentBotTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_platform_list_agent_bots',
    'List all platform-level agent bots.',
    {},
    async () => {
      try {
  ...
  server.tool(
    'chatwoot_platform_create_agent_bot',
    'Create a new platform-level agent bot.',
    {
    ...
    async (args) => {
      try {
        ...
        if (args.outgoing_url !== undefined) body.outgoing_url = args.outgoing_url;
  ...
  server.tool(
    'chatwoot_platform_get_agent_bot',
    'Get details of a specific platform-level agent bot.',
    {
  ...
  server.tool(
    'chatwoot_platform_update_agent_bot',
    'Update an existing platform-level agent bot.',
    {
  ...
  server.tool(
    'chatwoot_platform_delete_agent_bot',
    'Delete a platform-level agent bot.',
    {
