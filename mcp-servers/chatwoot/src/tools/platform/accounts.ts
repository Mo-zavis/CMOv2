...
export function registerPlatformAccountTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_platform_list_accounts',
    'List all accounts on the Chatwoot platform.',
    {},
    async () => {
      try {
  ...
  server.tool(
    'chatwoot_platform_create_account',
    'Create a new account on the Chatwoot platform.',
    {
  ...
  server.tool(
    'chatwoot_platform_update_account',
    'Update an existing account on the Chatwoot platform.',
    {
