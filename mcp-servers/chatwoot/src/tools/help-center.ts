...
export function registerHelpCenterTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_list_portals',
  ...
  server.tool(
    ...
    async (args) => {
      try {
        ...
        if (args.homepage_link !== undefined) body.homepage_link = args.homepage_link;
        if (args.page_title !== undefined) body.page_title = args.page_title;
        if (args.header_text !== undefined) body.header_text = args.header_text;
  ...
  server.tool(
    'chatwoot_get_portal',
    'Get a help center portal by its slug or ID.',
    {
  ...
  server.tool(
    'chatwoot_list_portal_categories',
    'List categories for a help center portal.',
    {
  ...
  server.tool(
    'chatwoot_create_portal_category',
    'Create a category in a help center portal.',
    {
      portal_id: z.string().describe('Portal slug or ID'),
  ...
  server.tool(
    'chatwoot_create_portal_article',
    'Create an article in a help center portal.',
    {
      portal_id: z.string().describe('Portal slug or ID'),
    ...
    async (args) => {
      try {
        ...
        if (args.author_id !== undefined) body.author_id = args.author_id;
