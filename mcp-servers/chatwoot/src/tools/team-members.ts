...
export function registerTeamMemberTools({ server, client }: ToolContext): void {
  server.tool(
    'chatwoot_list_team_members',
  ...
  server.tool(
    'chatwoot_update_team_members',
    'Update (replace) the members of a team.',
    {
      team_id: z.number().describe('ID of the team'),
